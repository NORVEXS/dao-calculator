    ...
    <div className="grid gap-5 lg:grid-cols-[360px_1fr]">
      <Card className="p-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-heading text-base font-semibold">{t("single.title")}</h3>
        </div>
        <p className="mt-1 text-sm text-muted-foreground">{t("single.subtitle")}</p>

        <div className="mt-6 space-y-2">
          <div className="flex items-end justify-between">
            <InfoLabel hint={t("single.dfHint")}>{t("hero.daylightFactor")}</InfoLabel>
        ...
        <div className="mt-4 rounded-lg border border-border/70 bg-muted/30 p-3">
          <div className="flex items-center justify-between">
            <span className="text-xs text-muted-foreground">{t("single.performance")}</span>
            <Badge variant="secondary">{t(`bands.${band.tone}`)}</Badge>
          </div>
          <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">
            {t(`bands.${band.tone}Desc`)}
          </p>
        </div>
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-heading text-base font-semibold">{t("single.curveTitle")}</h3>
            <p className="text-sm text-muted-foreground">{t("single.curveSubtitle")}</p>
          </div>
